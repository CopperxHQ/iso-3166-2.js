---
description: "Complete list of all 20 Eurozone countries with ISO codes and Euro adoption dates. Understand the difference between EU and Eurozone. TypeScript code examples for currency and membership checks."
---
...
> [!NOTE]
> Denmark has a formal opt-out from the Euro. The other 6 countries are technically required to adopt the Euro eventually (as part of their EU accession treaties), but there is no deadline, and several have no near-term plans to join.
